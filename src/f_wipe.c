...
int wipe_StartScreen(void) {
  ...
  screens[SRC_SCR] = wipe_scr_start;
  V_CopyRect(0, 0, 0, SCREENWIDTH, SCREENHEIGHT, 0, 0, SRC_SCR,
...
int wipe_EndScreen(void) {
  ...
  screens[DEST_SCR] = wipe_scr_end;
  V_CopyRect(0, 0, 0, SCREENWIDTH, SCREENHEIGHT, 0, 0, DEST_SCR,
             VPT_NONE); // Copy end screen to buffer
  V_CopyRect(0, 0, SRC_SCR, SCREENWIDTH, SCREENHEIGHT, 0, 0, 0,
