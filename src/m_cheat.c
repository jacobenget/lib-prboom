...
struct cheat_s cheat[] = {
  ...
  {"idk",        NULL,                not_net | not_demo | not_deh,
   cheat_k },  // The most controversial cheat code in Doom history!!!
    ...
    {"idbeholdv", "Invincibility", not_net | not_demo, cheat_pw,
     pw_invulnerability},

    {"idbeholds", "Berserk", not_net | not_demo, cheat_pw, pw_strength},

    {"idbeholdi", "Invisibility", not_net | not_demo, cheat_pw,
     pw_invisibility},
    ...
    {"tntkeybs", NULL, not_net | not_demo, cheat_tntkeyxx,
     it_blueskull}, // killough 2/16/98: end generalized keys
    ...
    {"tntammo", NULL, not_net | not_demo, cheat_tntammox,
     -1}, // killough 2/16/98: end generalized weapons
    ...
    {"tntamo", NULL, not_net | not_demo, cheat_tntammox,
     -1}, // killough 2/21/98: same as tntammo
